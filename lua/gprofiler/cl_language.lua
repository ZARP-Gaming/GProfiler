...
GProfiler.Language:AddLanguage("english", function(Lang)
	...
	Lang:AddPhrase("source", "Source")
	Lang:AddPhrase("remove", "Remove")
	Lang:AddPhrase("filter_source", "Filter Source")
	...
	Lang:AddPhrase("hook_list", "Hook List")
	...
	Lang:AddPhrase("profiler_no_explain", "EXPLAIN not possible for this query! (Must be SELECT, UPDATE or DELETE)")
	Lang:AddPhrase("profiler_no_data", "No data yet, start profiling to see results!")
	Lang:AddPhrase("profiler_copy_query", "Copy Query")
...
GProfiler.Language:AddLanguage("turkish", function(Lang)
	-- General
	Lang:AddPhrase("profiler_results", "Performans Sonuçları")
	Lang:AddPhrase("profiler_start", "Performans Takibini Başlat")
	Lang:AddPhrase("profiler_stop", "Performans Takibini Durdur")
	Lang:AddPhrase("realm_client", "İstemci")
	Lang:AddPhrase("realm_server", "Sunucu")
	Lang:AddPhrase("copy", "Kopyala")

	-- Column Names
	Lang:AddPhrase("file", "Dosya")
	Lang:AddPhrase("name", "İsim")
	Lang:AddPhrase("type", "Tür")
	Lang:AddPhrase("lines", "Satırlar")
	Lang:AddPhrase("realm", "Alan")
	Lang:AddPhrase("focus", "Odak")
	Lang:AddPhrase("source", "Kaynak")
	Lang:AddPhrase("remove", "Kaldır")
	Lang:AddPhrase("filter_source", "Kaynağı Filtrele")
	Lang:AddPhrase("function", "Fonksiyon")
	Lang:AddPhrase("receivers", "Alıcılar")
	Lang:AddPhrase("receiver", "Alıcı")
	Lang:AddPhrase("total_time", "Toplam Süre")
	Lang:AddPhrase("times_called", "Çağrılma Sayısı")
	Lang:AddPhrase("times_run", "Çalıştırılma Sayısı")
	Lang:AddPhrase("times_received", "Alınma Sayısı")
	Lang:AddPhrase("largest_size", "En Büyük Boyut")
	Lang:AddPhrase("total_size", "Toplam Boyut")
	Lang:AddPhrase("delay", "Gecikme")
	Lang:AddPhrase("timer", "Zamanlayıcı")
	Lang:AddPhrase("command", "Komut")
	Lang:AddPhrase("average_time", "Ortalama Süre")
	Lang:AddPhrase("longest_time", "En Uzun Süre")
	Lang:AddPhrase("entity", "Varlık")
	Lang:AddPhrase("variable", "Değişken")
	Lang:AddPhrase("times_updated", "Güncellenme Sayısı")
	Lang:AddPhrase("current_value", "Mevcut Değer")

	-- Profiler Specific
	Lang:AddPhrase("timer_function", "Zamanlayıcı Fonksiyonu")
	Lang:AddPhrase("timer_select", "Kodunu görüntülemek için bir zamanlayıcı seç")
	Lang:AddPhrase("function_details", "Fonksiyon Detayları")
	Lang:AddPhrase("function_select", "Kodunu görüntülemek için bir fonksiyon seç")
	Lang:AddPhrase("command_function", "Komut Fonksiyonu")
	Lang:AddPhrase("command_select", "Kodunu görüntülemek için bir komut seç")
	Lang:AddPhrase("hook_list", "Hook Listesi")
	Lang:AddPhrase("print_details", "Yazdırma Detayları")
	Lang:AddPhrase("printed", "Konsola Yazdırıldı")
	Lang:AddPhrase("requesting_source", "Sunucudan kaynak isteniyor...")
	Lang:AddPhrase("hook_select", "Kodunu görüntülemek için bir hook seç")
	Lang:AddPhrase("receiver_select", "Kodunu görüntülemek için bir alıcı seç")
	Lang:AddPhrase("profiler_no_explain", "Bu sorgu için AÇIKLAMA mümkün değil! (SEÇ, GÜNCELLE veya SİL olmalı)")
	Lang:AddPhrase("profiler_no_data", "Henüz veri yok, sonuçları görmek için performans takibi oluşturmayı başlat!")
	Lang:AddPhrase("profiler_copy_query", "Sorguyu kopyala")
	Lang:AddPhrase("profiler_no_profile", "Performans Takibi verisi mevcut değil! (100'den fazla sorgu yapılmış olabilir mi?)")

	-- Tab Names
	Lang:AddPhrase("tab_hooks", "Hook'lar")
	Lang:AddPhrase("tab_networking", "Ağ")
	Lang:AddPhrase("tab_functions", "Fonksiyonlar")
	Lang:AddPhrase("tab_commands", "Komutlar")
	Lang:AddPhrase("tab_timers", "Zamanlayıcılar")
	Lang:AddPhrase("tab_entity_variables", "Varlık Değişkenleri")
	Lang:AddPhrase("tab_network_variables", "Ağ Değişkenleri")
	Lang:AddPhrase("tab_database", "Veritabanı")
	Lang:AddPhrase("tab_auto_profile", "Otomatik Profiler")
end)